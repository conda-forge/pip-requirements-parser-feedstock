...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pip-requirements-parser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15641&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pip-requirements-parser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pip-requirements-parser` can be installed with:

```
conda install pip-requirements-parser
```

It is possible to list all of the versions of `pip-requirements-parser` available on your platform with:
